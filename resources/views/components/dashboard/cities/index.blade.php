<x-dashboard.layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <x-dashboard.navbars.navs.auth titlePage="Cities"></x-dashboard.navbars.navs.auth>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 border-radius-lg">
                            <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                                <h4 class="text-white text-capitalize ps-3">List Kota</h4>
                            </div>
                        </div>
                        <div class="container mt-2 mb-3">
                            <div class="my-3 text-end">
                                <a class="btn bg-gradient-success mb-0" href="{{ route('cities.create') }}">
                                    <i class="material-icons text-xl">add</i>&nbsp;Tambah Kota
                                </a>
                            </div>
                            <table class="table table-striped table-bordered data-table">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th class="text-center" width="100px">jumlah_merchant</th>
                                ...
                                <tbody>
                                    @foreach ($cities as $city)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $city->jumlah_merchant }}</td>
                                            <td class="text-center">

                                                <a href="{{ route('cities.edit', $city->id) }}" class="edit btn btn-warning btn-link btn-md m-0 p-2"><i class="material-icons">edit</i></a>
                                            <form action="{{ route('cities.destroy', $city->id) }}" method="POST" style="display: inline;" onsubmit="return confirmDelete()">
                                                @csrf
                                                @method('DELETE')
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $('.data-table').DataTable({
                        language: {
                            search: "Cari:",
                            lengthMenu: "Tampilkan _MENU_ data kota",
